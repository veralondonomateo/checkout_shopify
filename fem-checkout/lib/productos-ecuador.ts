 ...
 * precios van en dólares enteros con decimales (29.00), no en centavos: es
 * como se escriben en el resto del proyecto y evita confundir 29 con 0,29.
 *
 ...
 * ese antecedente. En la de 2 unidades sí es real —$58 es lo que costarían
...
export const PRESENTACIONES_EC: readonly PresentacionEC[] = [
  { slug: "1-unidad",  titulo: "1 unidad",   unidades: 1, precio: 29 },
  { slug: "2-unidades", titulo: "2 unidades", unidades: 2, precio: 49, precioAntes: 58 },
] as const;
...
/** $29.00 — sin decimales cuando el precio es redondo, que es el caso normal. */
