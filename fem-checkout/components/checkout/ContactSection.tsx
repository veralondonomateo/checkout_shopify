        ...
        <label className="flex items-center gap-2.5 cursor-pointer select-none group">
          <div className="relative">
            <input
              ...
              {...register("saveInfo")}
            />
            <div className="w-4 h-4 rounded border-2 border-gray-300 peer-checked:border-[#fc5245] peer-checked:bg-[#fc5245] transition-colors flex items-center justify-center group-hover:border-gray-400">
